  ...
  AppContext = (function(_super) {
    ...
    AppContext.prototype.RomsPWSContext = (function(_super1) {
      ...
      RomsPWSContext.accessor("imgPath", function() {
        return "/data/myocean/PWS-nowcast-l" + (this.get("rindex")) + "/images/" + (this.get("now").getUTCFullYear()) + "/" + (this.get("region")) + "_" + (this.get("variable")) + (padTo2Digits(this.get("now").getUTCMonth() + 1)) + (padTo2Digits(this.get("now").getUTCDate())) + "_" + (padTo2Digits(this.get("now").getUTCHours())) + "_0.jpg";
      });
